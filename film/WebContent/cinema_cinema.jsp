...
<html>
	...
	<body>
			...
			<div class="body">
				<div class="c_section1">
					...
					<table class="table table-hover clist" fit="true">
  						...
  						<tbody id="cinemalist" class="cbody">
  						</tbody>
					</table>
				</div>
				<div class="c_section2">
					...
					<div class="panel-group cpanelist" id="accordion">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/action_cinema.js" ></script>
	</body>
</html>
