...
<html>
	<head>
	    ...
	    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/singlecinema.css" />
		...
		<script type="text/javascript">
			var cinemaId = '${currentCinema.cinemaId}';
	...
	<body>
		<div class="bgp">
			...
			<div class="body">
				<div class="c_section1">
					<div class="search">
						<span class="cname">${currentCinema.name}</span>
						<span>排片表</span>
					</div>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/action_singlecinema.js" ></script>
